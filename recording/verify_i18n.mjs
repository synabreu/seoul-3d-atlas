...
const checks = [
  [html.includes('application-version" content="2.7"'), 'HTML application version is v2.7'],
  [html.includes('data-language="ko"') && html.includes('data-language="en"'), 'language buttons exist'],
  [app.includes("const ATLAS_VERSION = '2.7'"), 'runtime version is v2.7'],
  [app.includes("from './i18n.js?v=2.7-i18n-1'"), 'atlas uses i18n'],
  [hiking.includes("from './i18n.js?v=2.7-i18n-1'"), 'trails use i18n'],
  [apartments.includes("from './i18n.js?v=2.7-i18n-1'"), 'apartment explorer uses i18n'],
  [model.includes("from './i18n.js?v=2.7-i18n-1'"), 'price/date formatting uses i18n'],
